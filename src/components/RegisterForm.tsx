      ...
      <div className="flex justify-center items-center h-screen">
        ...
        <div className="relative bg-white px-12 py-6 rounded-lg max-w-[600px]">
          ...
          <button
            ...
            className="absolute top-[-5px] right-2 text-gray-700 text-2xl hover:scale-150 transition-transform active:scale-110"
          >
            ×
          </button>
          {/* title */}
          ...
          >
            ...
            />
            {firstNameIsEmpty ? (
              <span className="text-red-600  text-sm">Invalid first name</span>
            ) : null}
            ...
            />
            {lastNameIsEmpty ? (
              <span className="text-red-600  text-sm">Invalid last name</span>
            ) : null}
            <input
              type="submit"
              value="Register Now"
              className="text-white font-medium w-full py-1 mt-4 rounded-lg bg-green-600 hover:cursor-pointer hover:scale-105 active:scale-100 transition-transform"
            />
          </form>
        </div>
      </div>
